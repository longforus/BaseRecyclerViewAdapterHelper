...
//                canvas.drawText("Just some text", 0, 40, paint);
        ...
        multipleItemAdapter.setOnItemClickListener(new BaseQuickAdapter.OnItemClickListener<MultipleItem>() {
            @Override
            public void onItemClick(MultipleItem adapter, View view, int position) {
